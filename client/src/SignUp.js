...
const SignUp  = () => {
    ...
    <div className='bg-hmm bg-opacity-70 m-[60px] p-[50px] rounded-[35px] shadow-5xl text-left'>
        ...
        <img src={earth} alt="earth" className='absolute w-[880px] top-[50px] left-[900px] -z-10'></img>
                ...
                <div className='grid grid-cols-2 gap-3 w-[670px]'>
                    <input className='border relative w-[310px] h-[40px] rounded-[10px] bg-black py-1 px-2' type="text" placeholder='Budi'/>
                    <input className='border relative left-[50px] w-[310px] h-[40px] rounded-[10px] bg-black py-1 px-2' type="text" placeholder='Pekerti'/>
                </div>
                <br></br>
                <div className='felx flex-col mb-4'>
                    <label className='font-bold text-button text-[35px] py-1 px-2'>Username</label>
                    <div className='felx flex-col mb-4'>
                    <input className='border relative w-[700px] h-[40px] rounded-[10px] bg-black py-1 px-2' type="text"  placeholder='@budibaik123'/>
                </div>
                </div>
                <div className='felx flex-col mb-4'>
                    <label className='font-bold text-button text-[35px] py-1 px-2'>Password</label>
                    <div className='felx flex-col mb-4'>
                    <input className='border relative w-[700px] h-[40px] rounded-[10px] bg-black py-1 px-2' type="password" placeholder='akuanaksehAt_' />
                </div>
                </div>
                <br></br>
