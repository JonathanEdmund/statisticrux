  ...
  return ( 
    <div className="grid grid-cols-12 h-[100vh]">
      <div className="col-span-5 bg-button px-[90px] py-[30px] rounded-r-[50px] flex flex-col">
        ...
        <form onSubmit={handleSubmit} className="mx-auto mt-[45px] text-center">
          ...
          <input 
            placeholder="Naruto" 
            className="bg-black rounded-[16px] m-[10px] p-[11px] placeholder:font-bold placeholder:text-hmm"
            value={firstname}
          ...
          ></input>
          <div className="flex justify-start pl-[4%] mt-[2px]">
            <p className="font-bold text-[20px] leading-none mr-auto">Username</p>
          </div>
          <input 
            placeholder="narto" 
            className="bg-black rounded-[16px] m-[10px] p-[11px] w-[96%] placeholder:font-bold placeholder:text-hmm"
            value={lastname}
            onChange={(e) => setLastName(e.target.value)}
          ></input>
          <div className="flex justify-start pl-[4%] mt-[2px]">
            <p className="font-bold text-[20px] leading-none mr-[50%]">Date of Birth</p>
            <p className="font-bold text-[20px] leading-none ml-[4%]">Age</p>
          </div>
          <input 
            placeholder="31 Februari 2030" 
            className="bg-black rounded-[16px] m-[10px] p-[11px] w-[75.5%] placeholder:font-bold placeholder:text-hmm"
            value={date}
            onChange={(e) => setDate(e.target.value)}
          ></input>
          <input 
            placeholder="-7" 
            className="bg-black rounded-[16px] m-[10px] p-[11px] w-[15.5%] placeholder:font-bold placeholder:text-hmm"
            value={age}
          ...
          <input 
            ...
            className="bg-black rounded-[16px] m-[10px] p-[11px] w-[95%] placeholder:font-bold placeholder:text-hmm"
            value={id}
            onChange={(e) => setId(e.target.value)}
          ></input>
          <button type="submit" className="bg-live py-[10px] rounded-[15px] w-[30%] mr-[7.6%] mt-[20px] ml-[66.5%] font-bold text-[25px] leading-none hover:scale-105 ease duration-300">SAVE</button>
        </form>
      </div>
